...
export const NUM_PERIODS = 6;

export const DAYS = ['Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta'] as const;
export const DAYS_SHORT = ['Seg', 'Ter', 'Qua', 'Qui', 'Sex'] as const;

export const PERIODS = ['07:20', '08:05', '09:05', '09:50', '10:50', '11:35'] as const;
export const PERIOD_END_TIMES = ['08:05', '08:50', '09:50', '10:35', '11:35', '12:20'] as const;
