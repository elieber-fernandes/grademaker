...
import { Plus, Trash2, Clock, User, Book, Users } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

export const ProfessorsPage = () => {
    const { professors, subjects, addProfessor } = useStore();
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {professors.map((prof, index) => (
                    ...
                    >
                        ...
                        <button className="w-full py-3 border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 hover:text-indigo-600 flex items-center justify-center gap-2 transition-colors">
                            <Clock size={16} />
